...
class Reservation {
	...
	public Reservation(String pnrNumber, String trainNumber, String trainName, String classType, Date dateOfJourney,
...
class OnlineReservationSystem {
	...
	public String makeReservation(String trainNumber, String trainName, String classType, Date dateOfJourney,
			String from, String to) {
		String pnrNumber = "PNR" + pnrCounter++;
		Reservation reservation = new Reservation(pnrNumber, trainNumber, trainName, classType, dateOfJourney, from,
				to);
	...
	public static void main(String[] args) {
		...
		reservationSystem.addUser("userabi", "123");
		reservationSystem.addUser("userravee", "345");
		...
		if (reservationSystem.isValidUser(username, password)) {
			...
			String pnrNumber = reservationSystem.makeReservation("678", "Sample Express", "First Class", new Date(),
					"CityA", "CityB");
